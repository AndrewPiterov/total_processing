...
import 'package:total_processing/src/total_processing_mode.dart';
...
class TotalProcessingPlugin {
  ...
  void startCheckout(
      {required String checkoutId, required List<String> paymentBrands}) {
    _checkoutSettings(
        checkoutId: checkoutId,
        paymentBrands: paymentBrands,
        mode: TotalProcessingMode.test);
